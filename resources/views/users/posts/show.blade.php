                ...
                <div class="card-header bg-white">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            @else
                            {{-- If you are not the owner of the post, show a follow/unfollow button. To be discussed sonn. --}}{{-- Show follow button for now. --}}
                                ...
                                @foreach ($post->comments as $comment)
                                    <li class="list-group-item border-0 p-0 mb-2">
                                        ...
                                        <form action="{{ route('comment.destroy', $comment->id)}}" method="post">
                                            ...
                                            {{-- If the auth user is the owner of the commnet, show a delete button --}}
